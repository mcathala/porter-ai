...
export default function AdvisorPanel() {
  ...
  return (
    <>
      ...
      {/* Panel */}
      <div className="fixed right-0 top-0 bottom-0 w-full max-w-md bg-[#1a2632] border-l border-[#233648] z-50 flex flex-col shadow-2xl animate-in slide-in-from-right duration-300">
        {/* Header */}
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4">
          ...
          {isAdvisorTyping && (
            <div className="flex items-start gap-3">
              ...
              <div className="bg-[#111a22] rounded-2xl rounded-tl-sm px-4 py-3 text-gray-400">
        ...
        <form
          ...
          className="p-4 border-t border-[#233648] bg-[#111a22]"
        >
          <div className="flex items-center gap-2">
            <input
              ref={inputRef}
              ...
              className="flex-1 bg-[#1a2632] border border-[#233648] rounded-xl px-4 py-3 text-white placeholder:text-gray-500 focus:outline-none focus:border-emerald-500/50 focus:ring-1 focus:ring-emerald-500/50 disabled:opacity-50"
            />
            <button
              type="submit"
      ...
      <div
        className={`max-w-[85%] rounded-2xl px-4 py-3 ${
          isUser
            ...
            : "bg-[#111a22] text-gray-200 rounded-tl-sm"
        }`}
      >
        {isUser ? (
...
function SuggestedQuestion({
  ...
  return (
    <button
      ...
      className="w-full text-left px-4 py-3 bg-[#111a22] hover:bg-[#233648] border border-[#233648] rounded-xl text-sm text-gray-300 hover:text-white transition-colors"
    >
      {text}
    </button>
  );
