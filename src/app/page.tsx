...
export default function LandingPage() {
  return (
    <div className="relative flex h-screen w-full flex-col bg-[#101922] overflow-hidden text-white">
      ...
      {/* Header */}
      <header className="relative z-10 flex items-center justify-between whitespace-nowrap border-b border-solid border-[#233648] px-10 py-3 bg-[#111a22]/80 backdrop-blur-md">
      ...
      <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-6">
        ...
        <div className="max-w-3xl text-center mb-12">
          ...
          <h1 className="animate-fade-up-delay-1 text-5xl sm:text-6xl font-black leading-tight tracking-[-0.033em] mb-4">
          ...
          <p className="animate-fade-up-delay-2 text-[#92adc9] text-lg sm:text-xl leading-relaxed mb-8 max-w-2xl mx-auto">
          ...
          <div className="animate-fade-up-delay-3">
            <Link
              href="/onboarding"
              className="group inline-flex items-center justify-center h-14 px-10 rounded-xl bg-primary text-white font-bold text-lg shadow-lg shadow-primary/30 hover:shadow-xl hover:shadow-primary/40 hover:scale-105 active:scale-[0.98] transition-all duration-300 gap-2"
            >
              Start Playing
